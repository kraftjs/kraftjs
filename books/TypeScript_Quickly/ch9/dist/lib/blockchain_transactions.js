            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _b.label = 2;
                    case 2:
                        if (!this.hash.startsWith('0000')) return [3 /*break*/, 0];
                        _b.label = 3;
                    case 3:
                        return [2 /*return*/];
                }
...
var Blockchain = /** @class */ (function () {
    ...
    Object.defineProperty(Blockchain.prototype, "pendingTransactions", {
        get: function () {
            return __spreadArray([], this._pendingTransactions);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Blockchain.prototype, "chain", {
        get: function () {
            return __spreadArray([], this._chain);
        },
        enumerable: false,
        configurable: true
    });
...
export {Blockchain};
//# sourceMappingURL=blockchain_transactions.js.map