...
describe('timers', () => {
    ...
    let clock;
    beforeEach(() => {
        // By specifying that you want to mock only Date and setInterval, you’re free to use
        // the real setTimeout everywhere else, including within your withRetries function
    ...
    test('removing stale items', async () => {
        ...
        clock.tick(hoursInMilliseconds(4));
        monitorStaleItems();
        clock.tick(hoursInMilliseconds(2));
