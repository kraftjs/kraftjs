...
-- disappear after the session is closed or at the end of
-- the transaction if ON COMMIT is specified.
...
-- of the FROM clause.
SELECT c.first_name, c.last_name, r.rental_date::time AS rental_time
FROM customer AS c
